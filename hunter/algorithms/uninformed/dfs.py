...
class DFSAlgorithm(AIAlgorithm):
    """Depth-First Search (DFS) pathfinder.

    Explores deeply before backtracking using a LIFO stack. Might not yield optimal path.
    """
    ...
    def get_vis_data(self) -> Dict[str, Any]:
        ...
        # Convert stack tuple elements back to coordinate sets
